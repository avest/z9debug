...
// page.php
// --------------------
// process ajax request for paging of var/str data
//
...
$var_data_page = (isset($_POST['page'])) ? $_POST['page'] : 1;
debug::variable($var_data_page);

if (is_dir($request_dir))
{
	$var_data = get_var_data($request_dir, $var_data_page);
	debug::variable($var_data);

	include(Z9DEBUG_DIR.'/console/views/page.tpl.php');
}
?>